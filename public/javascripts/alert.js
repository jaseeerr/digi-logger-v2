...
*/
    !function (e, t) {
            ...
            q = (e, t, i) => {
                ...
                t.customClass && t.customClass[i]) {
                    if ("string" != typeof t.customClass[i] && ! t.customClass[i].forEach) 
                        return void r(`Invalid type of customClass.${i}! Expected string or iterable object, got "${
                            typeof t.customClass[i]
                        }"`);
            ...
            ue = (e, t) => {
                ...
                function (e, t, o) {
                    ...
                    function (e, t, o, i) {
                        ...
                        i.confirmButtonColor && (e.style.backgroundColor = i.confirmButtonColor, R(e, n["default-outline"]));
        ...
        const pe = (e, t) => {
            const o = g();
            o && (!function (e, t) {
                "string" == typeof t ? e.style.background = t : t || R([
                    document.documentElement, document.body
                ], n["no-backdrop"])
            }(o, t.backdrop),
            function (e, t) {
        ...
        const me = [
            ...
            ge = e => {
                if (!Ce[e.input]) 
                    return void a(`Unexpected type of input! Expected "text", "email", "password", "number", "tel", "select", "radio", "checkbox", "textarea", "file" or "url", got "${
                        e.input
                    }"`);
            ...
            ve = (e, t) => {
                ["string", "number"].includes(typeof t) ? e.value = `${t}` : m(t) || r(`Unexpected type of inputValue! Expected "string", "number" or "Promise", got "${
                    typeof t
                }"`)
            },
            Ce = {};
        ...
        const Ae = (t, o) => {
            ...
            $e = (e, t) => {
                ...
                t.toast ? (R([
                    document.documentElement, document.body
                ], n["toast-shown"]), R(e, n.toast)) : R(e, n.modal),
                q(e, t, "popup"),
                ...
                ((t, n) => {
                    ...
                    if (n.icon || n.iconHtml) {
                        if (n.icon && -1 === Object.keys(o).indexOf(n.icon)) 
                            return a(`Unknown icon! Expected "success", "error", "warning", "info" or "question", got "${
                                n.icon
                            }"`),
                            void K(s);
        ...
        const Me = () => B() && B().click(),
            ...
            Ne = (t, n, o) => {
                const i = e.innerParams.get(t);
                i && (n.isComposing || 229 === n.keyCode || (i.stopKeydownPropagation && n.stopPropagation(), "Enter" === n.key ? Fe(t, n, i) : "Tab" === n.key ? Re(n) : [
                    ... qe,
                    ... Ve
                ].includes(n.key) ? Ue(n.key) : "Escape" === n.key && _e(n, i, o)))
            },
            Fe = (e, t, n) => {
        ...
        const ze = () => {
            ...
            Ke = () => {
                ...
                if (t && n && ! e.match(/CriOS/i)) {
                    const e = 44;
                    b().scrollHeight > window.innerHeight - e && (g().style.paddingBottom =
                        `${e}px`)
                }
            },
            Ye = () => {
            ...
            Qe = () => {
                null === H.previousBodyPadding && document.body.scrollHeight > window.innerHeight && (
        ...
        const xt = e => {
            ...
            It =( t, n) => {
                const o = e.innerParams.get(t);
                if (! o.input) 
                    return void a(`The "input" parameter is needed to be set when using returnInputValueOn${
                        s(n)
                    }`);
        ...
        const Qt = e => {
            for (let t = e.target; t && t !== document; t = t.parentNode) 
                for (const e in Gt) {
                    ...
                    if (n) 
                        return void Gt[e].fire({template: n})
        ...
        var en = Object.freeze({
            ...
            argsToParams: e => {
                ...
                return "object" != typeof e[0] || Yt(e[0]) ? ["title", "html", "icon"].forEach(((n, o) => {
                    const i = e[o];
                    "string" == typeof i || Yt(i) ? t[n] = i : void 0 !== i && a(`Unexpected type of ${n}! Expected "string" or "Element", got ${
                        typeof i
                    }`)
                })) : Object.assign(t, e[0]),
                t
            ...
            bindClickHandler: function () {
                Gt[arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "data-swal-template"] = this,
        ...
        const nn =[
            ...
            an = e => {
                ...
                return n && (pn(n, ["src", "width", "height", "alt"]), n.hasAttribute("src") && (t.imageUrl = n.getAttribute("src")), n.hasAttribute("width") && (t.imageWidth = n.getAttribute("width")), n.hasAttribute("height") && (t.imageHeight = n.getAttribute("height")), n.hasAttribute("alt") && (t.imageAlt = n.getAttribute("alt"))),
                t
            },
            ln = e => {
                const t = {},
                    n = e.querySelector("swal-icon");
                return n && (pn(n, ["type", "color"]), n.hasAttribute("type") && (t.icon = n.getAttribute("type")), n.hasAttribute("color") && (t.iconColor = n.getAttribute("color")), t.iconHtml = n.innerHTML),
                t
            },
            cn = e => {
                const t = {},
            ...
            mn = e => {
                ...
                j() && (fn(t, e.scrollbarPadding, i), Array.from(document.body.children).forEach((e => {
            ...
            bn =( e, t, o) => {
                ...
                o.heightAuto && o.backdrop && ! o.toast && R([
                    document.documentElement, document.body
                ], n["height-auto"])
            };
        var yn =
        ...
        const An =( t, n, o) => new Promise(((i, s) => {
                ...
                ((e, t, n, o) => {
                    Ie(t),
                    n.toast || (t.keydownHandler = t => Ne(e, t, o), t.keydownTarget = n.keydownListenerCapture ? window : b(), t.keydownListenerCapture = n.keydownListenerCapture, t.keydownTarget.addEventListener("keydown", t.keydownHandler, {capture: t.keydownListenerCapture}), t.keydownHandlerAdded =! 0)
                })(t, ee, o, r),
                ((e, t) => {
                    "select" === t.input || "radio" === t.input ? Lt(e, t) : [
                        "text",
                        "email",
                        "number",
                        "tel",
                        "textarea"
                    ].includes(t.input) && (d(t.inputValue) || m(t.inputValue)) && (xt(B()), Ot(e, t))
                })(t, o),
                mn(o),
                Pn(ee, o, r),
                xn(n, o),
            ...
            kn =( e, t) => {
                ...
                return o.showClass = Object.assign({}, dt.showClass, o.showClass),
